...
ws1 = wb.active
ws1.title = "12账号写作风格"
ws1.append(["账号", "定位/风格", "标题公式/示例（必须参照，用《项目》替换实际主题）"])
rows1 = [
    ("①主号诗雨学姐", "甄嬛传故事风格——用后宫人物/场景类比知识点，需有具体数字和完整步骤", "《项目》超强总结！专治混乱记不住！"),
    ("②副号1学生视角", "蜡笔小新版生活故事——用真实生活场景（广志超市/家庭消费）带入知识点，篇幅较短、故事轻快", "《项目》超强总结！🏆把分喂到你嘴边！"),
    ("③副号2干货速记", "纯干货清单体，公式+分录直接罗列，适合快速记忆", "《项目》核算速记清单"),
    ("④副号3避坑吐槽", "错误写法vs正确写法对比体，专挑历年最容易踩的坑", "《项目》最容易踩的坑"),
    ("⑤副号4纯考点总结", "考点清单体，按定义→分类→公式→规则结构化整理", "《项目》核心考点超强总结"),
    ("⑥副号5考前冲刺", "开篇带距考试还有X天倒计时（按当天日期自动计算），营造紧迫感", "距中级还有65天存货冲刺"),
    ("⑦考前突击必背", "考点清单体，悬念/揭秘式标题，讲透底层逻辑（2026-07-02改版，原西游记故事号已停用）", "独家揭秘！《项目》底层逻辑"),
    ("⑧小新故事号", "小新家庭生活场景（区别于②，场景更家庭化）", "中级会计其实很水，《项目》背完保本70+"),
    ("⑨治愈猫咪插图号", "猫咪拟人化喵～语气，配图解风格讲解", "一张图讲清楚《项目》整章内容"),
    ("⑩治愈小狗插图号", "小狗拟人化图解，语气活泼亲切（2026-07-02改版，原西游记故事号2已停用）", "《项目》理清了，其实挺简单的，背完就稳了！"),
    ("⑪小新故事号2", "小新图解对比体（区别于⑧，侧重方法对比）", "《项目》考前必背清单，收藏这一条就够了"),
    ("⑫会计科普考点全览版", "背诵口诀+速查清单，收尾总结全篇", "《项目》考点速查背诵，收藏这条，比你多刷十道题有用"),
]
for r in rows1:
    ws1.append(list(r))
style_sheet(ws1, 1, [20, 60, 40])
